...
const StatusToggle = ({ enabled, setEnabled, label }) => {
  return (
    <div className={`${theme.cardBg} border ${theme.border} rounded-xl p-5 mb-6 flex items-center justify-between shadow-sm`}>
      <div>
        <h3 className="text-sm font-bold text-slate-900">{label}</h3>
        <p className={`text-xs ${theme.textMuted} mt-1`}>
          When enabled, the admin account is active.
        </p>
      </div>
...
const AddAdmin = () => {
  ...
  const handleSubmit = () => {
    ...
    console.log("Submitting admin:", payload);
        ...
        <div className="p-6 max-w-6xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className={`text-sm ${theme.textMuted} mt-2`}>
                Configure system access and profile settings.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            <div className="xl:col-span-2 space-y-6">
              <Card title="Admin Information" icon={User}>
              ...
              <Card title="Security Notes">
                <TextArea
                  ...
                  placeholder="Access rights, restrictions..."
                />
              </Card>
            </div>
            ...
            <div className="space-y-6">
              ...
              <Card title="Security Policy" icon={ShieldCheck}>
                <p className={`text-sm ${theme.textMuted} mb-4`}>
                  Admins have elevated privileges. Ensure compliance with
                  enterprise privacy and security guidelines.
                </p>

                <div className={`flex justify-between text-xs font-bold uppercase tracking-wider border-t ${theme.border} pt-4`}>
                  <span className={theme.textMuted}>Encryption</span>
                  <span className="text-slate-900">AES-256</span>
                </div>
              </Card>
            </div>
          </div>
